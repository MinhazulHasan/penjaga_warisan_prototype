	...
	theme: {
		...
		extend: {
			...
			keyframes: {
				...
				'pulse-glow': {
					'0%, 100%': { boxShadow: '0 0 5px hsl(45 85% 45% / 0.5)' },
					'50%': { boxShadow: '0 0 20px hsl(45 85% 45% / 0.8)' }
				},
				'heritage-glow': {
					'0%, 100%': { boxShadow: '0 0 10px hsl(45 95% 55% / 0.6)', transform: 'scale(1)' },
					'50%': { boxShadow: '0 0 30px hsl(45 95% 55% / 0.9)', transform: 'scale(1.05)' }
				},
				'royal-shine': {
